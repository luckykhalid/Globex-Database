...
docker exec -it module-09-container sqlcmd -S localhost,1433 -U sa -P Password123! -i ./db_schema.sql

docker exec -it module-09-container sqlcmd -S localhost,1433 -U sa -P Password123! -i ./db_data.sql
